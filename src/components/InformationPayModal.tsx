      ...
      >
        ...
        >
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              {[
                { label: 'CTK:', value: 'Nguyen Thanh Long', canCopy: false },
                { label: 'STK:', value: '9999889988', canCopy: true },
                { label: 'Ngân hàng:', value: 'Vietcombank', canCopy: false },
                ...
                >
                  ...
                  <Text
                    style={{ fontWeight: '600', fontSize: 14, lineHeight: 22 }}
                  >
                    {value}
                  </Text>
                  {canCopy && (
              ...
              >
                * Bạn có thể sao chép số tài khoản hoặc tải xuống mã QR để tiến
                hành thanh toán
              </Text>
            </View>
